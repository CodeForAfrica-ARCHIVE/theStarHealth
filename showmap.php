...
?>
    ...
    <script type="text/javascript" src="<?php bloginfo('template_url');?>/clusters/jquery-1.6.1.min.js"></script>        
    <script src="http://maps.google.com/maps/api/js?sensor=false" type="text/javascript"></script>
    <script type="text/javascript" src="<?php bloginfo('template_url');?>/clusters/gmap3.min.js"></script> 
  ...
  ?>
    ...
    <style>
      ...
      .cluster-1{
        background: url(<?php bloginfo('template_url');?>/clusters/images/m1.png) no-repeat;
        line-height:50px;
      	width: 50px;
      	height: 50px;
      }
      .cluster-2{
        background: url(<?php bloginfo('template_url');?>/clusters/images/m2.png) no-repeat;
        line-height:60px;
      	width: 60px;
      	height: 60px;
      }
      .cluster-3{
        background: url(<?php bloginfo('template_url');?>/clusters/images/m3.png) no-repeat;
        line-height:70px;
      	width: 70px;
      	height: 70px;
      }
      ...
      .infobulle.drive .text{
        background: url(<?php bloginfo('template_url');?>/clusters/images/drive.png) no-repeat 2px center;
	...
	<h4>Health Facilities</h4>
	 ...
	 <form>
	 <select value='county' style='width:100%' name="URL" onchange="window.location.href= '?dataset=facilities&county='+this.form.URL.options[this.form.URL.selectedIndex].value">
