...
</p><ol style="font-size:1.1em;" class="features"><li>ckan repository: this will serve as the back end of the app housing all the datasets.</li>
...
<li>Feature stories: The data analysed from the datasets within the repositoryis also used by journalists to provide content for feature stories</li></ol><p></p>
                </div>
            </div>
</div>