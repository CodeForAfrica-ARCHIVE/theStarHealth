		...
		<div class="container">
			<div id="page" class="hfeed row">
				...
				<header id="branding" role="banner" class="span12">
					...
					<hgroup align='left' style='padding:10px;'>
						<h1 id="site-title" style='display:inline;'>
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
								<img src='logo.png'> 
							</a><div style='display:inline;color:#fff'>Health</div>
						</h1>
						<h2 id="site-description" style='display:inline;'><?php bloginfo( 'description' ); ?></h2>
					</hgroup>
