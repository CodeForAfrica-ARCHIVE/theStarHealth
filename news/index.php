		...
		<link href='<?php echo $home;?>news/css/style.css' rel='stylesheet' type='text/css' />
			<link href='<?php echo $home;?>news/css/tabbedContent.css' rel='stylesheet' type='text/css' />
		<script src="<?php echo $home;?>news/js/tabbedContent.js" type="text/javascript"></script>
					...
					<div class='slide_content'>						
						<div class='tabslider'>
							...
							<ul>
								...
								$sql = mysql_query("SELECT * FROM news WHERE health='1'");
  ...
  <div class="modal-footer">
    <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
							...
							<ul>
								...
								<?php
								//show news in headline category
								$sql = mysql_query("SELECT * FROM news WHERE latest='1'");
								while($row = mysql_fetch_array($sql))
								{
									echo "<li><tr>
  ...
  <div class="modal-footer">
    <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
							...
							<ul>
								...
								<?php
								//show news in headline category
								$sql = mysql_query("SELECT * FROM news WHERE county='1'");
								while($row = mysql_fetch_array($sql))
								{
									echo "<li><tr>
