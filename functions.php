...
require_once('disability.php');
require_once('alld.php');


require_once('frontpage.php');
require_once('showarchive.php');
...
add_action( 'init', 'register_sp_taxonomies', 0 );

function register_sp_taxonomies() {
...
add_action( 'init', 'register_dis_taxonomies', 0 );

function register_dis_taxonomies() {
...
//register Specialty post type
add_action( 'init', 'create_Specialty' );
function create_Specialty() {
	...
	$labels = array(
		...
		'search_items' => __('Search Specialtys'),
		'not_found' =>  __('No Specialties found'),
		'not_found_in_trash' => __('No Specialtys found in Trash'),
		'parent_item_colon' => '',
	  ...
	  $Specialtyargs = array(
		...
		'has_archive' => 'Specialties',
		'hierarchical' => false,
		'menu_position' => 20,
		'menu_icon' => $icon,
		'taxonomies' => array('Specialty_cat', 'post_tag'),
		'supports' => array('title','editor','author','thumbnail','excerpt','comments','custom-fields', 'page-attributes')
	  ); 

	register_post_type( 'ps_Specialty', $Specialtyargs);
}




//create disease post type
add_action( 'init', 'create_Disease' );
function create_Disease() {

	$labels = array(
		'name' => _x('Diseases', 'post type general name'),
		'singular_name' => _x('Disease', 'post type singular name'),
		'add_new' => _x('Add New', 'book'),
		'add_new_item' => __('Add New Disease'),
		'edit_item' => __('Edit Disease'),
		'new_item' => __('New Disease'),
		'view_item' => __('View Disease'),
		'search_items' => __('Search Diseases'),
		'not_found' =>  __('No Diseases found'),
		'not_found_in_trash' => __('No Diseases found in Trash'),
		'parent_item_colon' => '',
		'menu_name' => 'Diseases'

	  );
		$icon = get_bloginfo ('template_directory');
		$icon .= '/images/Disease.png';
	  ...
	  $Diseaseargs = array(
		...
		'show_in_menu' => true,
		'query_var' => true,
		'rewrite' => array('slug' => 'Disease', 'with_front' => 'false'),
		'capability_type' => 'post',
		'has_archive' => 'Diseases',
		'hierarchical' => false,
		'menu_position' => 20,
		'menu_icon' => $icon,
		'taxonomies' => array('Disease_cat', 'post_tag'),
		'supports' => array('title','editor','author','thumbnail','excerpt','comments','custom-fields', 'page-attributes')
	  ); 

	register_post_type( 'ps_Disease', $Diseaseargs);
}

//hook into the init action and call create_book_taxonomies when it fires
add_action( 'init', 'create_Disease_taxonomies', 0 );

function create_Disease_taxonomies()
{
  $labels = array(
    'name' => _x( 'Disease Categories', 'taxonomy general name' ),
    'singular_name' => _x( 'Disease Category', 'taxonomy singular name' ),
    'search_items' =>  __( 'Search Disease Categories' ),
    'all_items' => __( 'All Disease Categories' ),
    'parent_item' => __( 'Parent Disease Category' ),
    'parent_item_colon' => __( 'Parent Disease Category:' ),
    'edit_item' => __( 'Edit Disease Category' ),
    'update_item' => __( 'Update Disease Category' ),
    'add_new_item' => __( 'Add New Disease Category' ),
    'new_item_name' => __( 'New Disease Category Name' ),
    'menu_name' => __( 'Disease Categories' ),
  ); 	

  register_taxonomy('Disease_cat', array('ps_Disease'), array(
    'hierarchical' => true,
    'labels' => $labels,
    'show_ui' => true,
    'query_var' => true,
